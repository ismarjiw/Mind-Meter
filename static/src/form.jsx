...
function WriteReflection() {
    ...
    return (
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="text-white bg-gradient-to-br from-purple-300 to-blue-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-md px-5 py-2.5 text-center mr-2 mb-2">Add Reflection</button>
      </form>
    );
  };
